...
public class RoundedDrawable extends Drawable {
    ...
    private ScalingUtils.ScaleType mScaleType = ScalingUtils.ScaleType.FIT_CENTER;
    ...
    private void updateShaderMatrix() {
        ...
        if (mScaleType == ScalingUtils.ScaleType.CENTER) {
        ...
        } else if (mScaleType == ScalingUtils.ScaleType.CENTER_CROP || mScaleType == ScalingUtils.ScaleType.FOCUS_CROP) {
            mBorderRect.set(mBounds);
            mBorderRect.inset(mBorderWidth / 2, mBorderWidth / 2);
        ...
        } else if (mScaleType == ScalingUtils.ScaleType.FIT_CENTER) {
            mBorderRect.set(mBitmapRect);
            mShaderMatrix.setRectToRect(mBitmapRect, mBounds, Matrix.ScaleToFit.CENTER);
            mShaderMatrix.mapRect(mBorderRect);
            mBorderRect.inset(mBorderWidth / 2, mBorderWidth / 2);
            mShaderMatrix.setRectToRect(mBitmapRect, mBorderRect, Matrix.ScaleToFit.FILL);
        } else if (mScaleType == ScalingUtils.ScaleType.FIT_END) {
            mBorderRect.set(mBitmapRect);
            ...
            mBorderRect.inset(mBorderWidth / 2, mBorderWidth / 2);
            mShaderMatrix.setRectToRect(mBitmapRect, mBorderRect, Matrix.ScaleToFit.FILL);
        } else if (mScaleType == ScalingUtils.ScaleType.FIT_XY) {
            mBorderRect.set(mBounds);
            mBorderRect.inset(mBorderWidth / 2, mBorderWidth / 2);
            mShaderMatrix.reset();
            mShaderMatrix.setRectToRect(mBitmapRect, mBorderRect, Matrix.ScaleToFit.FILL);
    ...
    public RoundedDrawable setScaleType(ScalingUtils.ScaleType scaleType) {
        if (scaleType == null) {
